-- ==============================================================================
-- MÓDULO PROVEEDORES - SUMINET ERP - GONZALO MARTINEZ ROMAN - CREACIÓN DE TABLAS
-- ==============================================================================

-- 09-Registro_Proveedores
-- Datos maestros de identificación y contacto de proveedores
...
-- Estandariza las actividades en las cuales se clasifica y segmenta a los proveedores y establece el tipo, criticidad y requerimientos particularesCatálogo de actividades estandarizas en las cuales se clasifica y segmenta a los proveedores. Establece el tipo, criticidad y requerimientos particulares. Clasificación por competencias/capacidades industriales.
...
-- Registra las certificaciones que posee un proveedor y su estado de vigencia.
...
-- Registra el estado e historial de la aptitud de un proveedor para suministrar productos  o servicios relacionados a una actividad. 
...
-- Contactos comerciales relacionados a un proveedor
